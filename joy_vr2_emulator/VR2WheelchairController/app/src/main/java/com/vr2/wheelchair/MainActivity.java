...
public class MainActivity extends AppCompatActivity implements VR2BleManager.VR2Callback {
    ...
    protected void onDestroy() {
        ...
        stopJoystickUpdates();
        if (bleManager != null) {
            bleManager.cleanup();        // unregister bond BroadcastReceiver
    ...
    /**
     * Called when ESP32 requests BLE pairing (first connection only).
     * Android will automatically show the system PIN dialog.
     * This toast tells the user what to do.
     */
    @Override
    public void onBondingRequired() {
        runOnUiThread(() ->
            Toast.makeText(this,
                "Pairing required — enter PIN when prompted",
     ...
     * Next connections will be automatic (no PIN needed).
     */
    @Override
    public void onBonded() {
        runOnUiThread(() ->
            Toast.makeText(this,
                "Paired! Future connections will be automatic.",
